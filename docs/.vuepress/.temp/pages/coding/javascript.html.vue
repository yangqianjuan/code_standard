<template><div><h1 id="javascript-编码规范" tabindex="-1"><a class="header-anchor" href="#javascript-编码规范" aria-hidden="true">#</a> JavaScript 编码规范</h1>
...
<h2 id="_1-编码风格" tabindex="-1"><a class="header-anchor" href="#_1-编码风格" aria-hidden="true">#</a> 1. 编码风格</h2>
<p><img src="@source/coding/img/JavaScript.svg" alt="javascript style"></p>
<p>详细规则如下：</p>
<h3 id="_1-1-缩进" tabindex="-1"><a class="header-anchor" href="#_1-1-缩进" aria-hidden="true">#</a> 1.1. 缩进</h3>
<ul>
<li>
<p>1.1.1.【强制】使用 2 个空格缩进。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/indent" target="_blank" rel="noopener noreferrer">indent<ExternalLinkIcon/></a></p>
...
<h3 id="_1-2-分号" tabindex="-1"><a class="header-anchor" href="#_1-2-分号" aria-hidden="true">#</a> 1.2. 分号</h3>
<ul>
<li>
<p>1.2.1.【强制】使用分号。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/semi" target="_blank" rel="noopener noreferrer">semi<ExternalLinkIcon/></a></p>
<p>统一以分号结束语句，可以避免 JS 引擎自动分号插入机制的怪异行为，在语义上也更加明确。</p>
<blockquote>
<p>自动分号插入机制（即 <a href="https://tc39.github.io/ecma262/#sec-automatic-semicolon-insertion" target="_blank" rel="noopener noreferrer">Automatic Semicolon Insertion<ExternalLinkIcon/></a>，简称 ASI） 是当 JS 遇到不带分号的语句时判断是否自动添加分号的机制，它在个别情况下的行为比较怪异，可能导致意想不到的效果。此外随着 JS 新特性的增加，异常的情况可能变得更加复杂。</p>
</blockquote>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 导致 Uncaught ReferenceError 报错</span>
...
<h3 id="_1-3-逗号" tabindex="-1"><a class="header-anchor" href="#_1-3-逗号" aria-hidden="true">#</a> 1.3. 逗号</h3>
<ul>
<li>
<p>1.3.1.【强制】对于逗号分隔的多行结构，不使用行首逗号。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/comma-style" target="_blank" rel="noopener noreferrer">comma-style<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>1.3.2.【强制】对于逗号分隔的多行结构，始终加上最后一个逗号。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/comma-dangle" target="_blank" rel="noopener noreferrer">comma-dangle<ExternalLinkIcon/></a></p>
<p>这样可以使增删行更加容易，也会使 <code v-pre>git diffs</code> 更清晰。<code v-pre>Babel</code> 等编译器会在编译后的代码里帮我们去掉最后额外的逗号，因此不必担心在旧浏览器中的问题。</p>
<div class="language-diff line-numbers-mode" data-ext="diff"><pre v-pre class="language-diff"><code>// bad - 没有结尾逗号时，新增一行的 git diff 示例
const hero = {
...
<h3 id="_1-4-块" tabindex="-1"><a class="header-anchor" href="#_1-4-块" aria-hidden="true">#</a> 1.4. 块</h3>
<blockquote>
<p>术语解释：<strong>块（block）</strong> 可以理解为类、函数、控制语句等由大括号 <code v-pre>{}</code> 分隔的代码块状结构，由一对大括号界定，用于组合若干条语句 <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/block" target="_blank" rel="noopener noreferrer">了解更多<ExternalLinkIcon/></a></p>
</blockquote>
<ul>
<li>
<p>1.4.1【推荐】始终使用大括号包裹代码块。eslint: <a href="https://eslint.org/docs/rules/curly" target="_blank" rel="noopener noreferrer">curly<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/nonblock-statement-body-position" target="_blank" rel="noopener noreferrer">nonblock-statement-body-position<ExternalLinkIcon/></a></p>
<p>多行代码块必须用大括号包裹：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<h4 id="_1-4-2-大括号换行风格" tabindex="-1"><a class="header-anchor" href="#_1-4-2-大括号换行风格" aria-hidden="true">#</a> 1.4.2. 大括号换行风格</h4>
<ul>
<li>
<p>1.4.2.1.【强制】对于非空代码块，采用 <code v-pre>Egyptian Brackets</code> 风格。eslint: <a href="https://eslint.org/docs/rules/brace-style" target="_blank" rel="noopener noreferrer">brace-style<ExternalLinkIcon/></a></p>
<p>对于非空的代码块，大括号的换行方式采用 <a href="https://blog.codinghorror.com/new-programming-jargon/" target="_blank" rel="noopener noreferrer">Egyptian Brackets<ExternalLinkIcon/></a> 风格，具体规则如下：</p>
<ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - else 应与 if 的 } 放在同一行</span>
<span class="token keyword">if</span> <span class="token punctuation">(</span>foo<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>但如果空代码块在多块结构中，仍建议按上一条非空块的 <code v-pre>Egyptian Brackets</code> 风格换行：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>1.4.3.【强制】不要使用空代码块。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-empty" target="_blank" rel="noopener noreferrer">no-empty<ExternalLinkIcon/></a></p>
...
<h3 id="_1-5-空格" tabindex="-1"><a class="header-anchor" href="#_1-5-空格" aria-hidden="true">#</a> 1.5. 空格</h3>
<p>合理并一致地使用空格有助于提升代码的可读性和可维护性。具体来说，我们采用如下的空格风格：</p>
<ul>
<li>
<p>1.5.1.【强制】空格风格。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/space-before-blocks" target="_blank" rel="noopener noreferrer">space-before-blocks<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/keyword-spacing" target="_blank" rel="noopener noreferrer">keyword-spacing<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/space-in-parens" target="_blank" rel="noopener noreferrer">space-in-parens<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/array-bracket-spacing" target="_blank" rel="noopener noreferrer">array-bracket-spacing<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/object-curly-spacing" target="_blank" rel="noopener noreferrer">object-curly-spacing<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/space-infix-ops" target="_blank" rel="noopener noreferrer">space-infix-ops<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/key-spacing" target="_blank" rel="noopener noreferrer">key-spacing<ExternalLinkIcon/></a></p>
...
<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">]</span><span class="token punctuation">;</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>foo<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>大括号内部两侧有空格：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<span class="token comment">// good</span>
<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token punctuation">{</span> <span class="token literal-property property">clark</span><span class="token operator">:</span> <span class="token string">'kent'</span> <span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运算符两侧有空格，除了一元运算符：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<h3 id="_1-6-空行" tabindex="-1"><a class="header-anchor" href="#_1-6-空行" aria-hidden="true">#</a> 1.6. 空行</h3>
<ul>
<li>
<p>1.6.1.【推荐】在文件末尾保留一行空行。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/eol-last" target="_blank" rel="noopener noreferrer">eol-last<ExternalLinkIcon/></a></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 文件末尾未保留换行符</span>
...
<li>
<p>1.6.2.【强制】块的开始和结束不能是空行。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/padded-blocks" target="_blank" rel="noopener noreferrer">padded-blocks<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<h3 id="_1-7-最大字符数和最大行数" tabindex="-1"><a class="header-anchor" href="#_1-7-最大字符数和最大行数" aria-hidden="true">#</a> 1.7. 最大字符数和最大行数</h3>
<ul>
<li>
<p>1.7.1.【推荐】单行最大字符数：100。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/max-len" target="_blank" rel="noopener noreferrer">max-len<ExternalLinkIcon/></a></p>
...
<li>
<p>1.7.2.【参考】文件最大行数：1000。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/max-lines" target="_blank" rel="noopener noreferrer">max-lines<ExternalLinkIcon/></a></p>
<p>过长的文件不易阅读和维护，最好对其进行拆分。</p>
</li>
<li>
<p>1.7.3.【参考】函数最大行数：80。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/max-lines-per-function" target="_blank" rel="noopener noreferrer">max-lines-per-function<ExternalLinkIcon/></a></p>
<p>过长的函数不易阅读和维护，最好对其进行拆分。</p>
</li>
</ul>
<h2 id="_2-语言特性" tabindex="-1"><a class="header-anchor" href="#_2-语言特性" aria-hidden="true">#</a> 2. 语言特性</h2>
<h3 id="_2-1-变量声明" tabindex="-1"><a class="header-anchor" href="#_2-1-变量声明" aria-hidden="true">#</a> 2.1. 变量声明</h3>
<ul>
<li>
<p>2.1.1.【强制】使用 <code v-pre>const</code> 或 <code v-pre>let</code> 声明变量。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-var" target="_blank" rel="noopener noreferrer">no-var<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/no-undef" target="_blank" rel="noopener noreferrer">no-undef<ExternalLinkIcon/></a></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>更不要什么都不用（这将产生全局变量，从而污染全局命名空间）：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>2.1.2.【强制】正确地使用 <code v-pre>const</code> 和 <code v-pre>let</code>。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/prefer-const" target="_blank" rel="noopener noreferrer">prefer-const<ExternalLinkIcon/></a></p>
<p>声明变量时，应优先使用 <code v-pre>const</code>，只有当变量会被重新赋值时才使用 <code v-pre>let</code>：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 声明后未发生重新赋值，应使用 const</span>
...
<li>
<p>2.1.3.【强制】一条声明语句声明一个变量。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/one-var" target="_blank" rel="noopener noreferrer">one-var<ExternalLinkIcon/></a></p>
...
<li>
<p>2.1.4.【强制】声明的变量必须被使用。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-unused-vars" target="_blank" rel="noopener noreferrer">no-unused-vars<ExternalLinkIcon/></a></p>
<p>声明而未使用的变量、表达式可能带来潜在的问题，也会给维护者造成困扰，应将它们删除。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 未使用变量 foo</span>
<span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
...
<li>
<p>2.1.5.【强制】不要在声明前就使用变量。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-use-before-define" target="_blank" rel="noopener noreferrer">no-use-before-define<ExternalLinkIcon/></a></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 如果权限校验（checkUserPermission）失败，fetchData 是不必要的</span>
...
<li>
<p>2.1.7.【强制】变量不要与外层作用域已存在的变量同名。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-shadow" target="_blank" rel="noopener noreferrer">no-shadow<ExternalLinkIcon/></a></p>
...
<li>
<p>2.1.8.【强制】不要重复声明变量和函数。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-redeclare" target="_blank" rel="noopener noreferrer">no-redeclare<ExternalLinkIcon/></a></p>
...
<li>
<p>2.1.9.【强制】禁止连续赋值。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-multi-assign" target="_blank" rel="noopener noreferrer">no-multi-assign<ExternalLinkIcon/></a></p>
<p>变量的连续赋值让人难以阅读和理解，并且可能导致意想不到的结果（如产生全局变量）。</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 本例的结果是 let 仅对 a 起到了预想效果，b 和 c 都成了全局变量</span>
...
<h3 id="_2-2-原始类型" tabindex="-1"><a class="header-anchor" href="#_2-2-原始类型" aria-hidden="true">#</a> 2.2. 原始类型</h3>
<blockquote>
<p><code v-pre>JS</code>的数据类型包括 7 种原始类型（primitive type），即 <code v-pre>Boolean</code>, <code v-pre>Null</code>, <code v-pre>Undefined</code>, <code v-pre>Number</code>, <code v-pre>String</code>, <code v-pre>Symbol</code> (ES6 新定义), <code v-pre>BigInt</code>（ES11 新定义），以及 <code v-pre>Object</code> 类型，<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures" target="_blank" rel="noopener noreferrer">了解更多<ExternalLinkIcon/></a>。这个章节主要介绍原始类型相关的规范。</p>
</blockquote>
<ul>
<li>
<p>2.2.1.【强制】不要使用 <code v-pre>new Number/String/Boolean</code>。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-new-wrappers" target="_blank" rel="noopener noreferrer">no-new-wrappers<ExternalLinkIcon/></a></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> str <span class="token operator">=</span> <span class="token string">'1'</span><span class="token punctuation">;</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> num <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">;</span>
...
<li>
<p>2.2.3.【推荐】使用 <code v-pre>parseInt()</code> 方法时总是带上基数。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/radix" target="_blank" rel="noopener noreferrer">radix<ExternalLinkIcon/></a></p>
...
<p>虽然从 <code v-pre>ES5</code> 开始就移除了自动以 8 作基数的规则，但有时难以保证所有的浏览器和 <code v-pre>JS</code> 执行环境都支持了这一特性。<a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/parseInt" target="_blank" rel="noopener noreferrer">了解更多<ExternalLinkIcon/></a></p>
...
<li>
<p>2.2.4.【强制】避免不必要的布尔类型转换。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-extra-boolean-cast" target="_blank" rel="noopener noreferrer">no-extra-boolean-cast<ExternalLinkIcon/></a></p>
...
<h4 id="_2-2-5-字符串" tabindex="-1"><a class="header-anchor" href="#_2-2-5-字符串" aria-hidden="true">#</a> 2.2.5. 字符串</h4>
<ul>
<li>
<p>2.2.5.1.【强制】字符串优先使用单引号。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/quotes" target="_blank" rel="noopener noreferrer">quotes<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>2.2.5.2.【推荐】使用模板字符串替代字符串拼接。eslint: <a href="https://eslint.org/docs/rules/prefer-template" target="_blank" rel="noopener noreferrer">prefer-template<ExternalLinkIcon/></a></p>
...
<li>
<p>2.2.5.3.【强制】禁止不必要的转义字符。<a href="https://eslint.org/docs/rules/no-useless-escape" target="_blank" rel="noopener noreferrer">no-useless-escape<ExternalLinkIcon/></a></p>
...
<h3 id="_2-3-数组" tabindex="-1"><a class="header-anchor" href="#_2-3-数组" aria-hidden="true">#</a> 2.3. 数组</h3>
<ul>
<li>
<p>2.3.1.【强制】使用字面量创建数组。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-array-constructor" target="_blank" rel="noopener noreferrer">no-array-constructor<ExternalLinkIcon/></a></p>
...
<li>
<p>2.3.2.【强制】某些数组方法的回调函数中必须包含 <code v-pre>return</code> 语句。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/array-callback-return" target="_blank" rel="noopener noreferrer">array-callback-return<ExternalLinkIcon/></a></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// 欲将 ['a', 'b', 'c'] 转换成 {a: 0, b: 1, c: 2}</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>数组拼接：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>用 <code v-pre>...</code> 替代 <code v-pre>apply</code>：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<h3 id="_2-4-对象" tabindex="-1"><a class="header-anchor" href="#_2-4-对象" aria-hidden="true">#</a> 2.4. 对象</h3>
<ul>
<li>
<p>2.4.1.【强制】使用字面量创建对象。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-new-object" target="_blank" rel="noopener noreferrer">no-new-object<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>2.4.2【强制】使用对象属性和方法的简写语法。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/object-shorthand" target="_blank" rel="noopener noreferrer">object-shorthand<ExternalLinkIcon/></a></p>
<p><code v-pre>ES6</code> 提供了对象属性和方法的简写语法，可以使代码更加简洁：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> value <span class="token operator">=</span> <span class="token string">'foo'</span><span class="token punctuation">;</span>
...
<li>
<p>2.4.4.【强制】对象的属性名不要用引号包裹，除非包含特殊字符。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/quote-props" target="_blank" rel="noopener noreferrer">quote-props<ExternalLinkIcon/></a></p>
...
<li>
<p>2.4.5.【强制】优先使用 . 访问对象的属性。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/dot-notation" target="_blank" rel="noopener noreferrer">dot-notation<ExternalLinkIcon/></a></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// very bad - original 会被影响</span>
...
<li>
<p>2.4.7.【推荐】使用解构获取对象属性。eslint: <a href="https://eslint.org/docs/rules/prefer-destructuring" target="_blank" rel="noopener noreferrer">prefer-destructuring<ExternalLinkIcon/></a></p>
...
<li>
<p>2.4.9.【强制】不要直接在对象上调用 <code v-pre>Object.prototypes</code> 上的方法。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-prototype-builtins" target="_blank" rel="noopener noreferrer">no-prototype-builtins<ExternalLinkIcon/></a></p>
...
<h3 id="_2-5-函数" tabindex="-1"><a class="header-anchor" href="#_2-5-函数" aria-hidden="true">#</a> 2.5. 函数</h3>
<ul>
<li>
<p>2.5.1.【强制】不要用 Function 构造函数创建函数。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-new-func" target="_blank" rel="noopener noreferrer">no-new-func<ExternalLinkIcon/></a></p>
...
<li>
<p>2.5.2.【强制】不要在块中使用函数声明。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-inner-declarations" target="_blank" rel="noopener noreferrer">no-inner-declarations<ExternalLinkIcon/></a></p>
<p>在非函数块（如 <code v-pre>if</code>、<code v-pre>while</code> 等）中，不要使用函数声明：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 函数声明不是块作用域而是函数作用域，因此在块外也能使用函数，容易引起误解</span>
...
<li>
<p>2.5.4.【强制】使用箭头函数代替匿名函数。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/prefer-arrow-callback" target="_blank" rel="noopener noreferrer">prefer-arrow-callback<ExternalLinkIcon/></a></p>
...
<li>
<p>2.5.5.【推荐】箭头函数编码风格。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/arrow-parens" target="_blank" rel="noopener noreferrer">arrow-parens<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/arrow-body-style" target="_blank" rel="noopener noreferrer">arrow-body-style<ExternalLinkIcon/></a></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// good - 函数体包含多条语句时，始终加上大括号</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - Uncaught SyntaxError: Unexpected token</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// good - 未使用 return 简写语法时，参数始终加上小括号</span>
<span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">]</span><span class="token punctuation">.</span><span class="token function">map</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">number</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  <span class="token keyword">const</span> nextNumber <span class="token operator">=</span> number <span class="token operator">+</span> <span class="token number">1</span><span class="token punctuation">;</span>
  <span class="token keyword">return</span> <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">A string containing the </span><span class="token interpolation"><span class="token interpolation-punctuation punctuation">${</span>nextNumber<span class="token interpolation-punctuation punctuation">}</span></span><span class="token string">.</span><span class="token template-punctuation string">`</span></span><span class="token punctuation">;</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<li>
<p>2.5.7.【强制】不要使用 <code v-pre>arguments</code> 对象。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/prefer-rest-params" target="_blank" rel="noopener noreferrer">prefer-rest-params<ExternalLinkIcon/></a></p>
...
<li>
<p>2.5.10.【推荐】不要修改函数参数。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-param-reassign" target="_blank" rel="noopener noreferrer">no-param-reassign<ExternalLinkIcon/></a></p>
...
<li>
<p>2.5.11.【强制】将立即执行函数表达式（<code v-pre>IIFE</code>）用小括号包裹。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/wrap-iife" target="_blank" rel="noopener noreferrer">wrap-iife<ExternalLinkIcon/></a></p>
...
<li>
<p>2.5.12.【参考】函数的复杂度不应过高。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/complexity" target="_blank" rel="noopener noreferrer">complexity<ExternalLinkIcon/></a></p>
...
<li>
<p>2.5.13.【参考】函数的参数不应过多。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/max-params" target="_blank" rel="noopener noreferrer">max-params<ExternalLinkIcon/></a>
...
<li>
<p>2.5.14.【强制】<code v-pre>generator</code> 函数内必须有 <code v-pre>yield</code> 语句。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/require-yield" target="_blank" rel="noopener noreferrer">require-yield<ExternalLinkIcon/></a></p>
...
<h3 id="_2-6-类" tabindex="-1"><a class="header-anchor" href="#_2-6-类" aria-hidden="true">#</a> 2.6. 类</h3>
<ul>
<li>
...
<p>ES6 class 会提供一个默认的 <code v-pre>constructor</code>，空 <code v-pre>constructor</code> 或者只调用父类的 <code v-pre>constructor</code> 是不必要的。eslint: <a href="https://eslint.org/docs/rules/no-useless-constructor" target="_blank" rel="noopener noreferrer">no-useless-constructor<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 以下两种 constructor 可以省略</span>
...
<li>
<p>2.6.4.【强制】正确地使用 super 方法。eslint: <a href="https://eslint.org/docs/rules/constructor-super" target="_blank" rel="noopener noreferrer">constructor-super<ExternalLinkIcon/></a> <a href="https://eslint.org/docs/rules/no-this-before-super" target="_blank" rel="noopener noreferrer">no-this-before-super<ExternalLinkIcon/></a></p>
<ul>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 非子类不能使用 super</span>
<span class="token keyword">class</span> <span class="token class-name">Parent</span> <span class="token punctuation">{</span>
  <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<li>
<p>2.6.5.【强制】避免重复的类成员命名。eslint: <a href="https://eslint.org/docs/rules/no-dupe-class-members" target="_blank" rel="noopener noreferrer">no-dupe-class-members<ExternalLinkIcon/></a></p>
...
<h3 id="_2-7-模块" tabindex="-1"><a class="header-anchor" href="#_2-7-模块" aria-hidden="true">#</a> 2.7. 模块</h3>
<ul>
<li>
<p>2.7.1.【推荐】使用 <code v-pre>ES6 modules</code> 而非其他非标准的模块系统。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import#module-systems" target="_blank" rel="noopener noreferrer">import/module-systems<ExternalLinkIcon/></a></p>
...
<li>
<p>2.7.2.【强制】不要用多个 <code v-pre>import</code> 引入同一模块。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/no-duplicates.md" target="_blank" rel="noopener noreferrer">import/no-duplicates<ExternalLinkIcon/></a></p>
...
<li>
<p>2.7.3.【强制】import 语句需要放到模块的最上方。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/first.md" target="_blank" rel="noopener noreferrer">import/first<ExternalLinkIcon/></a></p>
...
<li>
<p>2.7.4.【强制】禁止 <code v-pre>default import</code> 的名字跟文件内的其他 <code v-pre>export</code> 命名相同。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/no-named-as-default.md" target="_blank" rel="noopener noreferrer">import/no-named-as-default<ExternalLinkIcon/></a></p>
...
<li>
<p>2.7.5.【强制】禁止引用自身。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/no-self-import.md" target="_blank" rel="noopener noreferrer">import/no-self-import<ExternalLinkIcon/></a></p>
</li>
<li>
<p>2.7.6.【强制】禁止循环引用。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/no-cycle.md" target="_blank" rel="noopener noreferrer">import/no-cycle<ExternalLinkIcon/></a></p>
</li>
<li>
<p>2.7.7.【推荐】不要在 default export 上使用一个已导出的名称作为属性。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/no-named-as-default-member.md" target="_blank" rel="noopener noreferrer">import/no-named-as-default-member<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// foo.js</span>
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token string">'foo'</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token keyword">const</span> bar <span class="token operator">=</span> <span class="token string">'bar'</span><span class="token punctuation">;</span>
...
<li>
<p>2.7.8.【推荐】在模块导入之后保留一个空行。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/newline-after-import.md" target="_blank" rel="noopener noreferrer">import/newline-after-import<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
<span class="token keyword">import</span> foo <span class="token keyword">from</span> <span class="token string">'./foo.js'</span><span class="token punctuation">;</span>
...
<li>
<p>2.7.9.【参考】import 语句的排序。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/order.md" target="_blank" rel="noopener noreferrer">import/order<ExternalLinkIcon/></a></p>
...
<li>
<p>2.7.10.【参考】当模块内只有一个 <code v-pre>export</code> 时，使用 <code v-pre>default export</code>。<code v-pre>eslint</code>: <a href="https://github.com/benmosher/eslint-plugin-import/blob/master/docs/rules/prefer-default-export.md" target="_blank" rel="noopener noreferrer">import/prefer-default-export<ExternalLinkIcon/></a></p>
...
<li>
<p>2.7.12.【参考】模块开发者选择 EMS 和 CJS 时，需要判断运行时环境：如果你的模块是只面向浏览器的则选择 ESM；如果你的模块是只面向 Node.js 的则选择 CJS，并且确定遵循<a href="https://nodejs.org/api/esm.html#esm_commonjs_namespaces" target="_blank" rel="noopener noreferrer">CJS 命名空间规则<ExternalLinkIcon/></a>；如果你的模块是 2 者都要兼容的，则 ESM 和 CJS 都要支持。</p>
<p>Node.js 的模块，历史上 Node.js 遵循的是 CommonJS，因此 ES6 Module 会有比较严重的兼容性问题。暂时没有特别好的解法，只能在 Node.js 中跟进运行时环境，判断使用模块标准。<a href="https://github.com/nodejs/node/issues/33954" target="_blank" rel="noopener noreferrer">讨论 issue<ExternalLinkIcon/></a></p>
</li>
</ul>
<h3 id="_2-8-操作符" tabindex="-1"><a class="header-anchor" href="#_2-8-操作符" aria-hidden="true">#</a> 2.8. 操作符</h3>
<ul>
<li>
<p>2.8.1.【推荐】使用严格相等运算符。eslint: <a href="https://eslint.org/docs/rules/eqeqeq" target="_blank" rel="noopener noreferrer">eqeqeq<ExternalLinkIcon/></a></p>
<p>非严格相等运算符（<code v-pre>==</code> 和 <code v-pre>!=</code>）会在比较前将被比较值转换为相同类型，对于不熟悉 JS 语言特性的人来说，这可能造成不小的隐患。<a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Equality_comparisons_and_sameness" target="_blank" rel="noopener noreferrer">了解更多<ExternalLinkIcon/></a></p>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> id <span class="token operator">=</span> <span class="token string">'83949'</span><span class="token punctuation">;</span>
...
<li>
<p>2.8.2.【强制】不要使用一元自增自减运算符。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-plusplus" target="_blank" rel="noopener noreferrer">no-plusplus<ExternalLinkIcon/></a></p>
...
<li>
<p>2.8.3.【强制】不要使用 <code v-pre>void</code> 运算符。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-void" target="_blank" rel="noopener noreferrer">no-void<ExternalLinkIcon/></a></p>
...
<li>
<p>2.8.4.【强制】避免嵌套的三元表达式。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-nested-ternary" target="_blank" rel="noopener noreferrer">no-nested-ternary<ExternalLinkIcon/></a></p>
...
<li>
<p>2.8.5.【强制】避免不必要的三元表达式。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-unneeded-ternary" target="_blank" rel="noopener noreferrer">no-unneeded-ternary<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>2.8.6.【强制】混合使用多种操作符时，用小括号包裹分组。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-mixed-operators" target="_blank" rel="noopener noreferrer">no-mixed-operators<ExternalLinkIcon/></a></p>
...
<h3 id="_2-9-控制语句" tabindex="-1"><a class="header-anchor" href="#_2-9-控制语句" aria-hidden="true">#</a> 2.9. 控制语句</h3>
<ul>
<li>
<p>2.9.1.【强制】<code v-pre>switch</code> 语句中的 <code v-pre>case</code> 需要以 <code v-pre>break</code> 结尾。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-fallthrough" target="_blank" rel="noopener noreferrer">no-fallthrough<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>2.9.2.【推荐】<code v-pre>switch</code> 语句需要始终包含 <code v-pre>default</code> 分支。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/default-case" target="_blank" rel="noopener noreferrer">default-case<ExternalLinkIcon/></a></p>
...
<li>
<p>2.9.4.【参考】控制语句的嵌套层级不要过深。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/max-depth" target="_blank" rel="noopener noreferrer">max-depth<ExternalLinkIcon/></a></p>
...
<li>
<p>2.9.5.【强制】for 循环中的计数器应朝着正确方向移动。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/for-direction" target="_blank" rel="noopener noreferrer">for-direction<ExternalLinkIcon/></a></p>
...
<li>
<p>2.9.6.【推荐】<code v-pre>for-in</code> 循环中需要对 <code v-pre>key</code> 进行验证。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/guard-for-in" target="_blank" rel="noopener noreferrer">guard-for-in<ExternalLinkIcon/></a></p>
...
<li>
<p>2.9.7.【参考】如果一个 <code v-pre>if</code> 语句的结果总是返回一个 <code v-pre>return</code> 语句，那么最后的 <code v-pre>else</code> 是不必要的。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-else-return" target="_blank" rel="noopener noreferrer">no-else-return<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
<span class="token keyword">function</span> <span class="token function">foo</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token punctuation">{</span><span class="token punctuation">}</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<h3 id="_2-10-其他" tabindex="-1"><a class="header-anchor" href="#_2-10-其他" aria-hidden="true">#</a> 2.10. 其他</h3>
<ul>
<li>
<p>2.10.1.【强制】禁止使用 <code v-pre>eval</code>。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-eval" target="_blank" rel="noopener noreferrer">no-eval<ExternalLinkIcon/></a></p>
...
<li>
<p>2.10.2.【强制】禁止使用 <code v-pre>debugger</code>。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-debugger" target="_blank" rel="noopener noreferrer">no-debugger<ExternalLinkIcon/></a></p>
...
<li>
<p>2.10.3.【推荐】禁止使用 <code v-pre>alert</code>。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-alert" target="_blank" rel="noopener noreferrer">no-alert<ExternalLinkIcon/></a></p>
...
<li>
<p>2.10.4.【推荐】生产环境禁止使用 <code v-pre>console</code>。eslint: <a href="https://eslint.org/docs/rules/no-console" target="_blank" rel="noopener noreferrer">no-console<ExternalLinkIcon/></a></p>
...
<li>
<p>2.10.5.【强制】禁止对原生对象或只读的全局对象进行赋值。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-global-assign" target="_blank" rel="noopener noreferrer">no-global-assign<ExternalLinkIcon/></a></p>
...
<h2 id="_3-注释" tabindex="-1"><a class="header-anchor" href="#_3-注释" aria-hidden="true">#</a> 3. 注释</h2>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注释行上方需要有一个空行（除非注释行上方是一个块的顶部），以增加可读性：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 注释行上方需要一个空行</span>
...
<li>
<p>3.3.【强制】注释内容和注释符之间需要有一个空格。eslint: <a href="https://eslint.org/docs/rules/spaced-comment" target="_blank" rel="noopener noreferrer">spaced-comment<ExternalLinkIcon/></a></p>
...
<li>
<p>3.4.【参考】合理使用特殊注释标记。eslint: <a href="https://eslint.org/docs/rules/no-warning-comments" target="_blank" rel="noopener noreferrer">no-warning-comments<ExternalLinkIcon/></a></p>
...
<p>文档类注释，如函数、类、文件、事件等，推荐使用 <a href="http://usejsdoc.org/" target="_blank" rel="noopener noreferrer">jsdoc<ExternalLinkIcon/></a> 规范或类 jsdoc 的规范。</p>
<p>例如：</p>
...
<h2 id="_4-命名" tabindex="-1"><a class="header-anchor" href="#_4-命名" aria-hidden="true">#</a> 4. 命名</h2>
<ul>
<li>
...
<li>
<p>4.2.【参考】使用小驼峰（<code v-pre>camelCase</code>）命名原始类型、对象、函数、实例。<a href="https://eslint.org/docs/rules/camelcase" target="_blank" rel="noopener noreferrer">camelcase<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<li>
<p>4.3.【强制】使用大驼峰（<code v-pre>PascalCase</code>）命名类和构造函数。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/new-cap" target="_blank" rel="noopener noreferrer">new-cap<ExternalLinkIcon/></a></p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - 在本文件中使用的常量，不需使用 UPPERCASE_VARIABLES 风格</span>
...
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token comment">// bad - unnecessarily uppercases key while adding no semantic value</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用大驼峰（<code v-pre>PascalCase</code>）命名 <code v-pre>export</code> 的 class、函数库、字面量对象：</p>
<div class="language-javascript line-numbers-mode" data-ext="js"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> AnObject <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<li>
<p>4.6.【参考】命名不要以下划线开头或结尾。<code v-pre>eslint</code>: <a href="https://eslint.org/docs/rules/no-underscore-dangle" target="_blank" rel="noopener noreferrer">no-underscore-dangle<ExternalLinkIcon/></a></p>
...
<ul>
<li><a href="https://github.com/airbnb/javascript" target="_blank" rel="noopener noreferrer">Airbnb JavaScript Style Guide<ExternalLinkIcon/></a></li>
<li><a href="https://google.github.io/styleguide/jsguide.html" target="_blank" rel="noopener noreferrer">Google JavaScript Style Guide<ExternalLinkIcon/></a></li>
<li><a href="https://eslint.org/docs/rules/" target="_blank" rel="noopener noreferrer">ESLint rules<ExternalLinkIcon/></a></li>
</ul>
</div></template>
